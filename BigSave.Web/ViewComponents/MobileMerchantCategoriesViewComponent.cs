...
{
    public class MobileMerchantCategoriesViewComponent : ViewComponent
    {
        private readonly IMerchantRepository _merchantRepository;
        private readonly ICategoryRepository _categoryRepository;
        private readonly IMapper _mapper;

        public MobileMerchantCategoriesViewComponent(IMerchantRepository merchantRepository, ICategoryRepository categoryRepository, IMapper mapper)
        {
